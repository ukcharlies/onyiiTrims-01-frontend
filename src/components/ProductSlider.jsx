  ...
  return (
    <div className="relative">
      ...
      <div className="relative group">
        ...
        <button
          onClick={() => scroll(-1)}
          className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 hover:bg-white p-2 rounded-full shadow-lg transition-all duration-300 ${
        ...
        <button
          onClick={() => scroll(1)}
          className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 hover:bg-white p-2 rounded-full shadow-lg transition-all duration-300 ${
            showArrows ? "opacity-100" : "opacity-0 group-hover:opacity-100"
          }`}
          onMouseEnter={() => setShowArrows(true)}
          onMouseLeave={() => setShowArrows(false)}
